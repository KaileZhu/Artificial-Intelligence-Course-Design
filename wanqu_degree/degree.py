...
image_dir = "D:/Desktop/wanqu_degree/wanqu/train"
...
# 使用k均值聚类算法对图像进行分组 (修改num_clusters为2)
num_clusters = 2
...
# 显示聚类的结果并将其分类保存
cluster1_dir = "D:/Desktop/wanqu_degree/wanqu/train_cluster1"
cluster2_dir = "D:/Desktop/wanqu_degree/wanqu/train_cluster2"
